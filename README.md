...
Perhaps the most well known time series model is the Autoregressive integrated moving average or ["ARIMA"](https://en.wikipedia.org/wiki/Autoregressive_integrated_moving_average) model.